...
libraryDependencies += "org.xerial"          % "sqlite-jdbc"          % "3.53.2.0"    % "test" // latest version that works
...
libraryDependencies += "org.postgresql"      % "postgresql"           % "42.7.12"    % "test"

libraryDependencies += "com.mysql"               % "mysql-connector-j" % "9.7.0"    % "test"

libraryDependencies += "org.slf4j"           % "slf4j-simple"         % "2.0.18"    % "test"
